package com.dozycoffee.catalog.application.service;
...
public enum ProductErrors implements ServiceError {
    ...
    PRODUCT_NOT_ACTIVE_ERROR(50, "Product is not active"),
    SALES_OVERRIDE_NOT_FOUND_ERROR(51, "Sales override not found"),
    INVALID_OVERRIDE_ERROR(52, "Invalid sales override"),;
